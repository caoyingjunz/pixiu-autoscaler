...
func (ac *AutoscalerController) updateHPA(old, current interface{}) {
	...
	ac.handerHPAsEvent(cur, controller.Update)
}
...
func (ac *AutoscalerController) deleteHPA(obj interface{}) {
	...
	ac.handerHPAsEvent(h, controller.Delete)
}
...
func (ac *AutoscalerController) handerHPAsEvent(hpa *autoscalingv2.HorizontalPodAutoscaler, st controller.ScaleType) error {
