...
func CreateHorizontalPodAutoscaler(
	...
	minReplicasInt64, _ := strconv.ParseInt(annotations[KubezRootPrefix+KubezAnnotationSeparator+MinReplicas], 10, 32)
	maxReplicasInt64, _ := strconv.ParseInt(annotations[KubezRootPrefix+KubezAnnotationSeparator+MaxReplicas], 10, 32)
	targetCPUUtilizationPercentageInt64, _ := strconv.ParseInt(annotations[KubezRootPrefix+KubezAnnotationSeparator+TargetAverageUtilization], 10, 32)
	...
	metric := autoscalingv2.MetricSpec{
		...
		Resource: &autoscalingv2.ResourceMetricSource{
			...
			Target: autoscalingv2.MetricTarget{
				...
				AverageUtilization: utilpointer.Int32Ptr(int32(targetCPUUtilizationPercentageInt64)),
			},
		},
	}
